-- admin_marketing_summary SECURITY INVOKER ile çalışır.
-- ad_accounts token tuttuğu için authenticated'a GRANT yok → permission denied.
-- Site eşlemesi için token'sız ad_accounts_safe yeterli.
